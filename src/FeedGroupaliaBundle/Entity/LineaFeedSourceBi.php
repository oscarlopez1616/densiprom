 ...
 * LineaFeed
 *
 * @ORM\Table(name="linea_feed_source_bi",uniqueConstraints={@ORM\UniqueConstraint(name="sku_unique_index", columns={"sku"}),@ORM\UniqueConstraint(name="canonical_url_unique_index", columns={"canonical_url"})})
 * @ORM\Entity(repositoryClass="FeedGroupaliaBundle\Repository\LineaFeedSourceBiRepository")
 */
class LineaFeedSourceBi {
    ...
    function getMappedNameInfamilyAttribute() {
        $mappedAffiliationNameInFamily = "";
        switch ($this->nameInfamilyAttribute) {
            case 'Weekends&Travel':
                $mappedAffiliationNameInFamily = "Viajes&Travel";
                break;
            case 'Retail':
                $mappedAffiliationNameInFamily = "Shopping";
                break;
            case 'Restaurants&NightlifeRestaurantes':
                $mappedAffiliationNameInFamily = "Restaurantes";
                break;
            case 'Health&Beauty':
                $mappedAffiliationNameInFamily = "Health&BeautySalud y Belleza";
                break;
            case 'Other services':
                $mappedAffiliationNameInFamily = "Cursos";
                break;
            case 'Activities&Adventure':
                $mappedAffiliationNameInFamily = "Ocio";
                break;
            case '':
